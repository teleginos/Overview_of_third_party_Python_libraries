...
для получения погоды с сервиса Yandex в городе Москва\n""")
        ...
        print('По сравнению с базовым функционалом Python:\nВыполнение HTTP-запросов в чистом Python требует '
              'использования модулей http.client или urllib, что значительно сложнее и требует больше кода для '
    ...
    case 2:
        ...
        print('По сравнению с базовым функционалом Python:\n'
              'Выполнение математических операций с массивами в чистом Python требует написания циклов, что делает код '
              'медленнее и сложнее для чтения.')
    case 3:
        ...
        print('По сравнению с базовым функционалом Python:\n'
              'В чистом Python нет встроенных средств для создания графиков, поэтому использование matplotlib '
              'значительно упрощает задачу визуализации данных.')
    case 4:
        ...
        print('По сравнению с базовым функционалом Python:\n'
              'Работа с табличными данными в чистом Python требует использования списков и словарей, что менее '
              'эффективно и удобно по сравнению с использованием DataFrame из pandas.')
    case 5:
        ...
        print('По сравнению с базовым функционалом Python:\n'
              'В чистом Python нет встроенных средств для работы с изображениями, поэтому использование pillow '
              'значительно упрощает задачи, связанные с обработкой и манипуляцией изображениями.')